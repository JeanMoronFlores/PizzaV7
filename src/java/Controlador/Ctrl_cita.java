 ...
 * @author JEAN
 */
public class Ctrl_cita extends HttpServlet {

    String vistalistar = "ListarCitasjsp";
    String vistaagregar = "vistas/Agregarcitas.jsp";
    String vistaeditar = "vistas/EditarCitas.jsp";
    Cita esp = new Cita();
